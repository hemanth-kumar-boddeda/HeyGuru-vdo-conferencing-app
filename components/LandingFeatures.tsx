...
const FeatureItem = ({
  ...
  <div className="flex">
    <div className="flex-shrink-0">
      <div className="flex items-center justify-center w-12 h-12 rounded-md dark:bg-blue-600 dark:text-gray-50">
        {icon}
      </div>
    </div>
    <div className="ml-4">
        ...
        <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
          ...
          <div className="flex items-center justify-center ">
            <a href="#reviews" className="text-md text-center ">
              <p className="mt-4 bg-blue-300 px-2 py-1 rounded-lg text-white-900 font-light hover:font-extrabold">
