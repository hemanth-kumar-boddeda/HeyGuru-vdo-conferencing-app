          ...
          <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-gray-50">
            ...
            <div className="flex flex-wrap justify-center">
              ...
              <Link href={isSignedIn ? "/home" : "/sign-up"}>
                <Button
                  className="px-8 py-7 m-2 text-lg font-semibold rounded bg-blue-400 text-gray-900 hover:bg-transparent hover:text-blue-500 hover:border-blue-500 hover:border-2"
                >
              ...
              <Link href="#features">
                <Button
                  type="button"
                  className="px-8 py-7 m-2 text-lg border rounded border-blue-300 text-blue-200 hover:bg-blue-400 hover:text-gray-900 "
                >
                  Learn more
                </Button>
              </Link>
